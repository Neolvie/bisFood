...
{
  /// <summary>
  /// Класс расширения методов перечислений.
  /// </summary>
  public static class EnumExtenders
  {
    ...
    /// </summary>
    public static IList Units { get; set; }

    static EnumExtenders()
    {
      // Заполнение списка единиц измерения.
      Units = typeof(Shared.Core.Enum.Units).ToList();
    }
  }
}